...
###--------------------------------------------------------
# analyzing the fungi data at the level of family 
###--------------------------------------------------------

## the root sample

FUdata_r <- read.table(paste0(datapwd,"Fungi_family_data_root.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_fungi_family_root.txt",quote=FALSE)
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_fungi_family_root_",treatmentname[j],".txt"),quote=FALSE)
}
...
FUdata_s <- read.table(paste0(datapwd,"Fungi_family_data_rhizosphere.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_fungi_family_rhizosphere.txt",quote=FALSE)
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_fungi_family_rhizosphere_",treatmentname[j],".txt"),quote=FALSE)
}


###--------------------------------------------------------------
# analyzing the bacteria otu data at the level of family
###--------------------------------------------------------------

## the root sample

BAdata_r <- read.table(paste0(datapwd,"Bacteria_family_data_root.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_bacteria_family_root.txt",quote=FALSE)


## estimating the BLUEs
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_bacteria_family_root_",treatmentname[j],".txt"),quote=FALSE)
}


## the rhizosphere sample

BAdata_s <- read.table(paste0(datapwd,"Bacteria_family_data_rhizosphere.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_bacteria_family_rhizosphere.txt",quote=FALSE)
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_bacteria_family_rhizosphere_",treatmentname[j],".txt"),quote=FALSE)
}
