...
###--------------------------------------------------------
# analyzing the fungi data at the level of genus
###--------------------------------------------------------

## the root sample

FUdata_r <- read.table(paste0(datapwd,"Fungi_genus_data_root.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_fungi_genus_root.txt",quote=FALSE)
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_fungi_genus_root_",treatmentname[j],".txt"),quote=FALSE)
}
...
FUdata_s <- read.table(paste0(datapwd,"Fungi_genus_data_rhizosphere.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_fungi_genus_rhizosphere.txt",quote=FALSE)
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_fungi_genus_rhizosphere_",treatmentname[j],".txt"),quote=FALSE)
}
...
BAdata_r <- read.table(paste0(datapwd,"Bacteria_genus_data_root.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_bacteria_genus_root.txt",quote=FALSE)
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_bacteria_genus_root_",treatmentname[j],".txt"),quote=FALSE)
}


## the rhizosphere sample

BAdata_s <- read.table(paste0(datapwd,"Bacteria_genus_data_rhizosphere.txt"),header=TRUE)
...
write.table(repetability,"Result_heritability_bacteria_genus_rhizosphere.txt",quote=FALSE)
...
for (j in 1:ntr)
{
  ...
  write.table(blue_mat,paste0("BLUE_bacteria_genus_rhizosphere_",treatmentname[j],".txt"),quote=FALSE)
}
