...
###----------------------------------------------------------------------------------
#      Prediction for fitness traits using genomic data and microbiome ASVs
###----------------------------------------------------------------------------------
    ...
    for (i in 1:nscenario)
    {
      ...
      for (m in 1:ngen)
      {
        ...
        fit.gblup <- BGLR(yNA,
                          ...
                          burnIn = 2000,
                          verbose = FALSE,
                          saveAt = paste0("GP_G_and_Micro_predict_phenotype_",
                                          traitname[l],"_",
                                          treatmentname[k],".txt")
        )
...
write.table(res_pa,"results_G_and_microbiome_predict_phenotype_pa.txt",quote=FALSE)
write.table(res_sd,"results_G_and_microbiome_predict_phenotype_sd.txt",quote=FALSE)
